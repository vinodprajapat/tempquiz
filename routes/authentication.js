...
module.exports = (router) => {
  ...
  router.post('/login', (req, res) => {
    ...
    console.log(" in user aunthehcation sjdcsv dsgcysgduy");
    // Check if username was provided
    if (!req.body.username) {
  ...
  router.get('/profile', (req, res) => {
    ...
    User.findOne({ _id: req.decoded.userId }).select('firstname lastname mobile username email attempted_quizes').exec((err, user) => {
